...
class Client:
    ...
    def train(self, w_global,round):
        ...
        return weights,training_flops,num_comm_params, tst_results
    ...
    def local_test(self, w, b_use_test_dataset = True):
        ...
        return metrics
    def val_test(self, w, val_data_local):
        self.model_trainer.set_model_params(w)
        metrics = self.model_trainer.test(val_data_local, self.device, self.args)
        return metrics