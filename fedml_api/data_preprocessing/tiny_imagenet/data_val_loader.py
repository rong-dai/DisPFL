...
def get_dataloader_tiny(datadir, train_bs, test_bs, dataidxs=None,test_idxs=None, cache_train_data_set=None,cache_test_data_set=None):
...
def load_partition_data_tiny( data_dir, partition_method, partition_alpha, client_number, batch_size, logger):
    ...
    for client_idx in range(client_number):
        ...
        val_data_local, _ = get_dataloader_tiny( data_dir, batch_size, batch_size,
