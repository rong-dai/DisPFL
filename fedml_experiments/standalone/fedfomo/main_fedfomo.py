...
def load_data(args, dataset_name, logger):
    if dataset_name == "cifar10":
        ...
        train_data_local_num_dict, train_data_local_dict, val_data_local_dict, test_data_local_dict, \
    ...
    dataset = [train_data_num, test_data_num, train_data_global, test_data_global,
               train_data_local_num_dict, train_data_local_dict, val_data_local_dict, test_data_local_dict, class_num]
    return dataset
...
if __name__ == "__main__":
    ...
    parser = add_args(argparse.ArgumentParser(description='FEDFOMO-standalone'))
    ...
    args.identity = "fedfomo"  + "-"+data_partition
    ...
    fedfomoAPI = FEDFOMOAPI(dataset, device, args, model_trainer, logger)
    fedfomoAPI.train()